...
const BLOG_POSTS = [
 ...
 {
    id: "daemon-local-agent",
    title: "Coasty Daemon: AI That Controls Your Local Machine",
    excerpt: "Our daemon runs as a lightweight CLI and executes agent commands directly on your computer. No VMs, no latency. Your browser, your files, your desktop.",
    author: "Michael Rodriguez",
    date: "2026-02-18",
    read_time: "7 min",
    category: "Product",
    keywords: ["daemon", "local agent", "computer use"],
    content: [
      { type: "intro", text: "Until now, Coasty agents ran inside cloud VMs. That works great for many use cases, but some tasks need to happen on your actual machine: your browser sessions, your local files, your installed apps. That is why we built Coasty Daemon." },
      { type: "section", title: "How It Works", bullets: ["A lightweight CLI daemon runs on your machine", "Agent commands execute directly via MCP stdio or WebSocket", "Browser automation uses your installed Chrome, Edge, or Brave", "File operations work with your local filesystem", "Desktop automation handles mouse, keyboard, and window management", "All communication is authenticated with secure tokens"] },
      { type: "section", title: "Why Local Matters", text: "Cloud VMs are great for isolated tasks, but many real workflows need access to your logged-in sessions, local credentials, and installed tools. Coasty Daemon bridges that gap while maintaining security through command whitelisting and token-based auth." },
      { type: "conclusion", text: "Coasty Daemon brings the full power of autonomous AI agents to your local machine. Same intelligence, zero latency, your environment." },
    ],
  },
  {
